                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (!empty($c['image_path'])): ?>
                                    <img src="../<?php echo htmlspecialchars($c['image_path']); ?>" alt="Issue photo" class="complaint-image-thumb" onclick="window.location.href='../view_image.php?file=<?php echo urlencode(basename($c['image_path'])); ?>'">
                                <?php else: ?>
