<?php
session_start();
if (!isset($_SESSION['user_id']) || $_SESSION['role'] !== 'admin' || $_SESSION['department'] !== 'garbage') {
...
$threads = $conn->query("
    ...
    WHERE c.department = '$dept' AND EXISTS (SELECT 1 FROM messages WHERE complaint_id = c.id)
...
if ($selected_id > 0) {
    ...
    while ($msg_result && $m = $msg_result->fetch_assoc()) { $selected_messages[] = $m; }
}
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Messages - Garbage Department - CivicSolve</title>
    <link rel="stylesheet" href="../admin.css">
    <link rel="stylesheet" href="../../assets/css/theme.css">
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&display=swap" rel="stylesheet">
</head>
<body>
    <nav class="navbar admin-nav dept-garbage">
        <div class="container">
            <a href="home.php" class="logo">CivicSolve <span class="badge-dept">GARBAGE DEPT</span></a>
            <div class="nav-links">
        ...
        <div class="container">
            ...
            <div class="messages-layout">
                <div class="thread-list">
                    <div class="thread-list-header"><h3>Complaint Threads</h3><span class="thread-count"><?php echo $threads ? $threads->num_rows : 0; ?> conversations</span></div>
                        ...
                        <?php else: ?>
                            ...
                            <a href="messages.php?complaint_id=<?php echo $t['complaint_id']; ?>" class="thread-item <?php echo ($selected_id == $t['complaint_id']) ? 'active' : ''; ?> <?php echo ($t['unread'] > 0) ? 'unread' : ''; ?>">
                                ...
                                <div class="thread-info">
                                    ...
                                    <div class="thread-meta"><span class="badge status-<?php echo $t['status']; ?>"><?php echo ucfirst(str_replace('_',' ',$t['status'])); ?></span><?php if ($t['unread'] > 0): ?><span class="unread-badge"><?php echo $t['unread']; ?> new</span><?php endif; ?></div>
                                </div>
                            </a>
                            <?php endwhile; ?>
                        <?php endif; ?>
